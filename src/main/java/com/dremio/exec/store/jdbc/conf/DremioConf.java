...
/**
 * Configuration for Dremio sources.
 */
@SourceType(value = "DREMIOARP", label = "Dremio", uiConfig = "dremioarp-layout.json", externalQuerySupported = true)
public class DremioConf extends AbstractArpConf<DremioConf> {
  ...
  private String toJdbcConnectionString() {
    ...
    return String.format("jdbc:dremio:direct=%s:%s", hostname, port);
